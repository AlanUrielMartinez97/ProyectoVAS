<h3>Bienvenid@ al Sistema de Gestion de Asistencia Escolar</h3>
<hr>
<div class="col-12">
                ...
                <div class="card-body">
                    <div class="w-100 d-flex align-items-center">
                        ...
                        <div class="col-auto flex-grow-1">
                            <div class="fs-5"><b>Divisiónes</b></div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="w-100 d-flex align-items-center">
                        ...
                        <div class="col-auto flex-grow-1">
                            <div class="fs-5"><b>Alumnos</b></div>
                            <div class="fs-6 text-end fw-bold">
                                <?php 
