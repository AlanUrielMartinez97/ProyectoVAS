...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        ...
        <div class="card-tools align-middle">
            <button class="btn btn-dark btn-sm py-1 rounded-0" type="button" id="create_new">Agregar Nuevo Alumno</button>
        </div>
    </div>
    <div class="card-body">
        <table class="table table-hover table-striped table-bordered">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center p-0">Matricula</th>
                    <th class="text-center p-0">Nombre</th>
                    <th class="text-center p-0">División/Grupo</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="py-0 px-1">
                        <small><span class="text-muted">Divisón:</span> <?php echo $row['dept'] ?></small><br>
                        <small><span class="text-muted">Grupo:</span> <?php echo $row['position'] ?></small>
                    </td>
                    <td class="py-0 px-1">
...
<script>
    $(function(){
        $('#create_new').click(function(){
            uni_modal('Agregar Nuevo Alumno',"manage_employee.php",'mid-large')
        })
        $('.edit_data').click(function(){
            uni_modal('Editar Detalle de Alumno',"manage_employee.php?id="+$(this).attr('data-id'),'mid-large')
        })
        $('.view_data').click(function(){
            uni_modal('Alumno Detalles',"view_employee.php?id="+$(this).attr('data-id'),'mid-large')
        })
