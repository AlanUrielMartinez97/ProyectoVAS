        ...
        <form action="" id="filter">
            <div class="row align-items-end mb-3">
                <div class="form-group col-md-3">
                    <label for="employee_id" class="control-label">Alumno</label>
        ...
        <table class="table table-hover table-striped table-bordered" id="list">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center p-0">Alumno</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="py-1 px-1 lh-1">
                        <small><span class="text-muted">Matricula:</span> <?php echo $row['employee_code'] ?></small><br>
                        <small><span class="text-muted">División:</span> <?php echo $row['dept'] ?></small><br>
                        <small><span class="text-muted">Grupo:</span> <?php echo $row['pos'] ?></small><br>
