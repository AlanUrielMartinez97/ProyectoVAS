            ...
            <div class="row h-100">
                <div class="col-md-6 h-100 d-flex flex-column">
                    <div class="w-100 d-flex border-bottom border-dark py-1 mb-1">
                        <div class="fs-5 col-auto flex-grow-1"><b>Lista de Divisiones academicas</b></div>
                        <div class="col-auto flex-grow-0 d-flex justify-content-end">
                            <a href="javascript:void(0)" id="new_department" class="btn btn-dark btn-sm bg-gradient rounded-2" title="Agregar División"><span class="fa fa-plus"></span></a>
                        </div>
                    </div>
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex">
                                ...
                                <div class="col-auto d-flex justify-content-end">
                                    <a href="javascript:void(0)" class="edit_department btn btn-sm btn-primary bg-gradient py-0 px-1 me-1" title="Editar Detalles de División" data-id="<?php echo $row['department_id'] ?>"  data-name="<?php echo $row['name'] ?>"><span class="fa fa-edit"></span></a>

                                    <a href="javascript:void(0)" class="delete_department btn btn-sm btn-danger bg-gradient py-0 px-1" title="Eliminar División" data-id="<?php echo $row['department_id'] ?>"  data-name="<?php echo $row['name'] ?>"><span class="fa fa-trash"></span></a>
                                </div>
                            </li>
                            <?php endwhile; ?>
                ...
                <div class="col-md-6 h-100 d-flex flex-column">
                    <div class="w-100 d-flex border-bottom border-dark py-1 mb-1">
                        <div class="fs-5 col-auto flex-grow-1"><b>Lista de Grupos</b></div>
                        <div class="col-auto flex-grow-0 d-flex justify-content-end">
                            <a href="javascript:void(0)" id="new_position" class="btn btn-dark btn-sm bg-gradient rounded-2" title="Agregar Grupo"><span class="fa fa-plus"></span></a>
                        </div>
                    </div>
                    <div class="h-100 overflow-auto border rounded-1 border-dark">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex">
                                ...
                                <div class="col-auto d-flex justify-content-end">
                                    <a href="javascript:void(0)" class="edit_position btn btn-sm btn-primary bg-gradient py-0 px-1 me-1" title="Editar Detalles de Grupo" data-id="<?php echo $row['position_id'] ?>"  data-name="<?php echo $row['name'] ?>"><span class="fa fa-edit"></span></a>

                                    <a href="javascript:void(0)" class="delete_position btn btn-sm btn-danger bg-gradient py-0 px-1" title="Eliminar Grupo" data-id="<?php echo $row['position_id'] ?>"  data-name="<?php echo $row['name'] ?>"><span class="fa fa-trash"></span></a>
                                </div>
                            </li>
                            <?php endwhile; ?>
                            <?php if(!$dept_qry->fetchArray()): ?>
...
<script>
    $(function(){
        $('#new_department').click(function(){
            uni_modal('Agregar Nuevo División',"manage_department.php")
        })
        $('.edit_department').click(function(){
            uni_modal('Editar Detalles de División',"manage_department.php?id="+$(this).attr('data-id'))
        })
        ...
        $('#new_position').click(function(){
            uni_modal('Agregar Nuevo Grupo',"manage_position.php")
        })
        $('.edit_position').click(function(){
            uni_modal('Editar Detalles de Grupo',"manage_position.php?id="+$(this).attr('data-id'))
        })
