            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="employee_code" class="control-label">Matricula del alumno </label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="department_id" class="control-label">División</label>
                        <select name="department_id" id="department_id" class="form-select form-select-sm select2 rounded-0">
                            <option <?php echo (!isset($department_id)) ? 'selected' : '' ?> disabled>Selecciona tu División</option>
                            <?php
                    ...
                    <div class="form-group">
                        <label for="position_id" class="control-label">Grupo</label>
                        <select name="position_id" id="position_id" class="form-select form-select-sm select2 rounded-0">
                            <option <?php echo (!isset($position_id)) ? 'selected' : '' ?> disabled>Selecciona tu Grupo</option>
                            <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="avatar" id="avatar" required class="form-control form-control-sm rounded-0" accept="image/png,image/jpeg,image/jpg" <?php echo !isset($employee_id) ? 'required' : '' ?> onchange="display_img(this)">
                    </div>
